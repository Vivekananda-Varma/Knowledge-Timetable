                    ...
                    <div class="row">
                        <div class="col-xl-10 mx-auto">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                <!-- <a href="/teachers/courses/select/" class="btn btn-soft-primary btn-sm px-3 py-1">Edit</a> -->
                            </div>
                        ...
                        ?>    
                                <div class="card mb-3 lift bg-soft-<?= $color ?>" data-href="/teachers/courses/id/<?= $course_id ?>/">
