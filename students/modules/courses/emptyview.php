            ...
            <div class="container pt-15 pt-md-17 pb-13 pb-md-15 text-center">
                <div class="row">
                    <div class="col-md-9 col-lg-7 col-xl-7 mx-auto text-center">
                        ...
                        <p class="lead fs-md mb-6 px-xl-10 px-xxl-15">Start by adding courses you would like to sign up for in this academic year. They will appear here.</p>
                        <a href="/students/courses/select/" class="btn btn-primary rounded">Find Courses</a>
                    </div>
                </div>
            </div>
        </section>
